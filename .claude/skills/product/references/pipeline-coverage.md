...
| 06 | OST | sonnet | `docs/ost.md` (Opportunity Solution Tree — 1 outcome root → 3-5 opportunities → 2-3 solutions per) | ≥ 3 KB | (legacy) | spec 032 Decision 12 (Torres) |
| 07 | Sitemap-IA | sonnet | `docs/sitemap.yaml` (schema-bound to `references/sitemap-schema.md` — `required_categories: [marketing, auth, primary, admin, error]` enforced) | ≥ 2 KB | (legacy) | spec 032 Decisions 5 + 13 (load-bearing root-cause fix) |
...
| 12 | GTM-launch | sonnet | `docs/gtm-launch.md` (positioning canvas Dunford + launch plan 4-week sketch + pricing strategy) | ≥ 4 KB | (legacy) | spec 032 Decision 7 (Stage-Gate stage 6 + April Dunford) |
