#!/usr/bin/env bash
# .claude/tests/compaction-continuity/run-all.sh
# Orchestrator for spec-081 scenarios. Mirrors the session-handoff runner.
...
printf '\n=== compaction-continuity scenario results ===\n'
printf '%s\n' "$results"
printf '==============================================\n'
