...
The `.claude/memory/` bucket covers all three trigger classes — pure-reference (CC-32-hooks), full-rule reclassification (spec 096), and split companions (spec 097).
