#!/usr/bin/env bash
# .claude/tests/session-handoff-multi-runtime/run-all.sh
# Orchestrator for spec-101 multi-runtime session-handoff fixtures.
...
printf '\n=== session-handoff-multi-runtime scenario results ===\n'
printf '%s\n' "$results"
printf '=======================================================\n'
