...
- **Priority recommendations** — the severity × effort batches: which findings to fix before crossing the gate, which can wait.
...
- **Fix the findings.** Step 4 audits and recommends; remediation is the team's, and the design-system / prototype-v2 steps (6, 7) are where the fixes land.
