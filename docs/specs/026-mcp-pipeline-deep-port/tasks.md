...
- [ ] 10. **Step 1 — ideation port** (`anthill-product-ideator`). Single-artifact `04-concept-brief.md`; content depth increases (hook, target audience, differentiation, risks, validation_mode extraction). No HTML, no extra_files. References: founder-interview discipline, concept-brief examples.
