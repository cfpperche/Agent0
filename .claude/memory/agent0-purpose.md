...
- Statusline lives at `.claude/presence/statusline.mjs` (adapted from agent-core, Apache-2.0). Wired via `.claude/settings.json` `statusLine.command`. Runtime state under `.agent/runtime/` (gitignored).
