...
- **Color story** — color *names* + *feelings* (e.g. "Anchor on a single saturated cyan as the only on-signal; warm-near-black as the canvas; secondary cyan-tinted greys for hierarchy"). **NOT hex codes.** Hex + token names are step 6.
