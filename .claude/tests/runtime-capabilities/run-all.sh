#!/usr/bin/env bash
# .claude/tests/runtime-capabilities/run-all.sh
# Orchestrator for spec-093 runtime capability registry scenarios.
...
results=""
any_fail=0
tmpout="$(mktemp -t runtime-capabilities-run-all-XXXXXX)"
...
printf '\n=== runtime-capabilities scenario results ===\n'
printf '%s\n' "$results"
printf '=============================================\n'
